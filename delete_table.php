					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								...
								<span class="caption-subject font-green-sharp bold uppercase">Delete Daten</span>
                            ...
                            <div class="container">
                                <div class="row form-group">
									...
									<div class="col-md-2">
                                        <span class="help-block">
											Date </span>
										<select class="form-control select2me" data-placeholder="Select..." id="selecttabledate" multiple>
											<!-- <option value=""></option> -->
										</select>	
									...
									<div class="col-md-2">
										<span class="help-block" hidden>
											. </span>
										<button type="submit" class="col-md-12 btn red" onclick="dataDelete()">Delete</button>
                                    </div>
                                </div>
                            </div>
...
<script>
    ...
    function dataDelete(){
		...
		if (csvdate ==null || csvdate == ''){
            alert('You did not select date, please select date');
            return;
        }
		if (confirm("Are you going to delete "+csvdate+" Data?")) {
			$.ajax({ //create an ajax request to display.php
				type: "GET",
				...
				dataType: "html", //expect html to be returned                
				success: function(response) {
					window.location.href = "delete_table.php";
